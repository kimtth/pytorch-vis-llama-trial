...
ckpt_path = os.path.join(os.getcwd(), 'model', 'Llama-2-7b-hf')
clip_path = os.path.join(os.getcwd(), 'model', 'clip-vit-large-patch14')
# ckpt_path = './ckpt' 
# clip_path = './clip' 
model_path = os.path.join(os.getcwd(), 'out.pt')
image_path = r'mini-modal\dataset\coco2017\val2017\000000000139.jpg'
...
model = MultimodalLlamaLLM(image_length=5, llama=llama_model,)
